...
7. **Your code is your portfolio.** Alongside the project, you must deliver a personal portfolio website (see Exercise 2) presenting previous work with screenshots and/or live links.
---
...
- Handle failure, rate limits, and cost. Show us you thought about what happens when the API is down or slow.
...
## Exercise 2 — Personal Portfolio Website
 
Deliver a **personal portfolio website** (can live in the same repo under `/portfolio` or its own repo — your call).
...
```
/backend           # Exercise 1 backend
/frontend          # Exercise 1 frontend (or integrated)
/portfolio         # Exercise 2 (or separate repo linked in README)
docker-compose.yml
README.md          # see below
```
